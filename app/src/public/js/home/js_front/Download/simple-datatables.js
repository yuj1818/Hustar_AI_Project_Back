    ...
    return function t(e, s, i) {
                ...
                (function() {
                    ...
                    var e = {
                        ...
                        var $ = function() {
                            ...
                            ,
                            m.$set = function(t, e) {
                                var o, l = M.p(t), u = "set" + (this.$u ? "UTC" : ""), p = (o = {},
                                o[r] = u + "Date",
                                o[c] = u + "Date",
                                o[h] = u + "Month",
                                o[d] = u + "FullYear",
                            ...
                            m.diff = function(s, c, u) {
                                var p, f = M.p(c), g = x(s), m = (g.utcOffset() - this.utcOffset()) * t, b = this - g, v = M.m(this, g);
                                return v = (p = {},
                                p[d] = v / 12,
                                p[h] = v,
                                p[l] = v / 3,
                        ...
                        [["$ms", s], ["$s", i], ["$m", a], ["$H", n], ["$W", r], ["$M", h], ["$y", d], ["$D", c]].forEach((function(t) {
                            T[t[1]] = function(e) {
        ...
        2: [function(t, e, s) {
            ...
            const d = function(t) {
                ...
                e && (null !== this.dom.tHead && this.dom.removeChild(this.dom.tHead),
            ...
            class u {
                ...
                fixColumns() {
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        ...
                        this.dom.tHead) {
                            this.options.scrollY.length && (e = a("thead"),
                            e.appendChild(a("tr")),
                            e.style.height = "0px",
                ...
                import(t) {
                    ...
                    if (s.data.length || i(s.data)) {
                        if ("csv" === s.type) {
                            ...
                            s.removeDoubleQuotes && (e.headings = e.headings.map((t=>t.trim().replace(/(^"|"$)/g, "")))),
                            t.shift()),
                            t.forEach(((t,i)=>{
                                e.data[i] = [];
                                const a = t.split(s.columnDelimiter);
                                a.length && a.forEach((t=>{
                                    s.removeDoubleQuotes && (t = t.trim().replace(/(^"|"$)/g, "")),
                                    e.data[i].push(t)
                                }
                                ))
                            }
